...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, count(i.kitapno) \n" +
            "FROM ogrenci AS o LEFT JOIN islem AS i ON o.ogrno = i.ogrno\n" +
            "WHERE o.sinif IN('10A', '10B') GROUP BY o.sinif";
    ...
    //--Ali: 2, Mehmet: 3
    String QUESTION_7 = "SELECT ad, COUNT(ad) AS ogrenci_sayisi\n" +
            "FROM ogrenci\n" +
            "GROUP BY ad;";
